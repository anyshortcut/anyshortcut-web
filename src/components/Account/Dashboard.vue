    ...
    <div class="dashboard">
        <div class="left-panel">
            ...
            <div class="navigation">
                <router-link to="/account/shortcuts" class="font">Shortcuts</router-link>

                <router-link to="/account/subscription" class="font">Subscription</router-link>

                <router-link to="/account/profile" class="font">Profile</router-link>
            </div>
        </div>
