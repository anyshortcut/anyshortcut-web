<template>
    <div class="pro">
        ...
        <div class="content">
            ...
            <ul>
                <li><a href="#" @click="open1()" class="open">Anyshortcut command line interface</a></li>
                <li><a href="#" @click="open2()" class="open">Anyshortcut for Alfred Workflow</a></li>
            </ul>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
          open1() {
            window.open("https://github.com/anyshortcut/anyshortcut-cli")
          },
          open2() {
            window.open("https://github.com/anyshortcut/anyshortcut-workflow")
          }
        }
    }
</script>
